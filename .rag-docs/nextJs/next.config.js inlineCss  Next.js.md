...
### When to Use Inline CSS[](https://nextjs.org/docs/app/api-reference/config/next-config-js/inlineCss#when-to-use-inline-css)
...
### When Not to Use Inline CSS[](https://nextjs.org/docs/app/api-reference/config/next-config-js/inlineCss#when-not-to-use-inline-css)
...
](https://nextjs.org/docs/app/api-reference/config/next-config-js/incrementalCacheHandlerPath)[Next
